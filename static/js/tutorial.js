...
function next_8() {
    ...
    $('#how-it-works-question').html('<h5 class="tuto_title">Settings:</h5> <p style="color: black;" id="defza">This is the settings button. You can restrict your quiz by requiring a password to access it, reset your quiz to start from scratch, or simply delete your quiz.</p><button class="next_buttons" onclick="next_9()">Next</button>'); 
}
...
function next_9() {
    ...
    $('#how-it-works-question').html('<h5 class="tuto_title">Questions:</h5> <p style="color: black;" id="defza">You can modify questions order by swiping them with your mouse or with your finger on mobile phone.</p><button class="next_buttons" onclick="next_10()">Next</button>'); 
}

function next_10() {
    $('#how-it-works-question').html('<h5 class="tuto_title">Choices:</h5> <p style="color: black;" id="defza">You can easily add choices to questions by right-clicking on the ones you wish to modify. This allows you to add new choices, delete existing ones, or assign truth values (true/false) to them for more precise control.</p><button class="next_buttons" onclick="next_10()">Next</button>'); 
}

function next_10() {
    $('#how-it-works-question').html('<h5 class="tuto_title">Saves:</h5> <p style="color: black;" id="defza">After making any modifications, press the (Save) button that will appear to apply your changes.</p><button class="next_buttons" onclick="next_11()">Finish</button>'); 
}
